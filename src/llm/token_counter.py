...
MODEL_REGISTRY: dict[str, ModelSpec] = {
    ...
    "openai/gpt-oss-120b":       ModelSpec(128_000, supports_tools=True, supports_json_mode=True),
    "llama-3.1-70b-versatile":       ModelSpec(131_072, supports_tools=True, supports_json_mode=True),
    "openai/gpt-oss-120b":          ModelSpec(131_072, supports_tools=True, supports_json_mode=True),
